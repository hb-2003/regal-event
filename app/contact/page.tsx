      ...
      <section className="section" style={{ background: "#011F23" }}>
        <div className="container-x grid-1-2" style={{ maxWidth: 1100, marginInline: "auto" }}>
          <div>
            ...
            <h2 className="lux-title reveal" style={{ transitionDelay: ".1s", marginBottom: 32 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 36 }}>
              {contactRows.map((item) => (
                ...
                >
                  <span style={{ color: "#FCCD97", fontSize: "1.1rem", flexShrink: 0, marginTop: 2 }}>
                    {item.icon}
                  </span>
                  <div>
                    <p
                    ...
                    {item.href ? (
                      <a
                        ...
                        onMouseLeave={(e) =>
                          ((e.currentTarget as HTMLElement).style.color = "#F9F4EE")
                        }
                      >
                        {item.value}
                      </a>
                ...
                {contact.socialLinks.map((s) => (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ...
                      el.style.borderColor = "#FCCD97";
                      el.style.color = "#FCCD97";
                    }}
                    onMouseLeave={(e) => {
                      const el = e.currentTarget as HTMLElement;
                      el.style.borderColor = "rgba(252,205,151,.2)";
                      el.style.color = "rgba(249,244,238,.5)";
                    }}
                  >
                    {s.label}
                  </a>
            ...
            <div className="reveal" style={{ overflow: "hidden", aspectRatio: "16/9", maxHeight: 240 }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d159287.98690218752!2d-0.3817765!3d51.52800745!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a00baf21de75%3A0x52963a5addd52a99!2sLondon%2C%20UK!5e0!3m2!1sen!2s!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0, filter: "grayscale(1) invert(0.9)", display: "block" }}
                loading="lazy"
                title="London Map"
              />
            </div>
          ...
          <div>
            <div className="s-label reveal" style={{ transitionDelay: ".05s" }}>
              Send a Message
            </div>
            <h2 className="lux-title reveal" style={{ transitionDelay: ".1s", marginBottom: 32 }}>
            ...
            {status === "success" ? (
              <div
                ...
                style={{
                  ...
                  textAlign: "center",
                  borderColor: "rgba(252,205,151,.3)",
                }}
              >
                ...
                <p style={{ color: "rgba(249,244,238,.5)", marginBottom: 24, fontSize: ".88rem" }}>
              ...
              >
                {[
                  ...
                  <div key={f.key}>
                    <label className="lux-label">
                      {f.label} {f.req && <span style={{ color: "#FCCD97" }}>*</span>}
                    </label>
                    <input
                      type={f.type}
                      required={f.req}
                ...
                <div>
                  <label className="lux-label">
                    Message <span style={{ color: "#FCCD97" }}>*</span>
                  </label>
                  <textarea
                    required
                    rows={5}
                ...
                {status === "error" && (
                  <p style={{ color: "#e07070", fontSize: ".85rem" }}>
